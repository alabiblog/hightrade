      ...
      <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
        ...
        <aside className="w-full md:w-72 bg-white shadow-xl p-6 flex flex-col gap-8 md:h-screen">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-black text-sm">USER ID:{session?.user?.id}</p>
          </div>
        ...
        <main className="flex-1 p-4 sm:p-6 md:p-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              <h2 className="text-lg font-semibold text-gray-700">Active Trades</h2>
              <p className="mt-2 text-2xl font-bold text-indigo-600">0 Trades</p>
            </div>
